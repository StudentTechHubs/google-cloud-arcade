...
echo "${BG_MAGENTA}${BOLD}          WELCOME TO STUDENTTECHHUB                     ${RESET}"
echo "${BG_MAGENTA}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${CYAN}${BOLD}         Google Cloud Monitoring Tutorial               ${RESET}"
echo "${YELLOW}For more GCP tutorials, visit: https://www.youtube.com/@StudentTechHubs${RESET}"
echo
...
echo "${BG_GREEN}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${RED}${BOLD}🙏 Thank you for following STUDENTTECHHUB!${RESET}"
echo "${YELLOW}${BOLD}📺 Subscribe for more GCP monitoring content:${RESET}"
echo "${BLUE}https://www.youtube.com/@StudentTechHubs${RESET}"
echo
