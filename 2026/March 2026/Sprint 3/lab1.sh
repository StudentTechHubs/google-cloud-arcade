...
echo "${RANDOM_BG_COLOR}${RANDOM_TEXT_COLOR}${BOLD}Welcome to STUDENTTECHHUB${RESET}"
...
{
  "type": "pubsub",
  "displayName": "studenttechhub",
  "description": "studenttechhub",
  "labels": {
...
echo "${BOLD}${CYAN}Thank you for using STUDENTTECHHUB${RESET}"
