...
echo "${CYAN_TEXT}${BOLD_TEXT}        CAMPUSPERKS CLOUD KMS LAB - SUBSCRIBE FOR MORE          ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}Subscribe to CampusPerks for more Google Cloud Arcade Labs${RESET_FORMAT}"
