...
echo "${PINK_TEXT}${BOLD_TEXT}🚀     PerkVerse EXECUTION STARTED     🚀${RESET_FORMAT}"
echo "${PINK_TEXT}${BOLD_TEXT}===================================${RESET_FORMAT}"
echo
...
gcloud artifacts repositories create monolith-demo --location=$REGION --repository-format=docker --description="Subscribe to PerkVerse"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Subscribe to PerkVerse for more! 👇${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@PerkVers${RESET_FORMAT}"
