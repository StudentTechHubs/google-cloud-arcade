...
echo -e "${GREEN_TEXT}${BOLD_TEXT}Task 2: Creating private cluster...${RESET_FORMAT}"
...
echo -e "${TEAL_TEXT}${BOLD_TEXT}Task 4: Creating VM for connectivity test...${RESET_FORMAT}"
...
echo -e "${MAGENTA_TEXT}Fetching NAT IP...${RESET_FORMAT}"
...
echo -e "${PURPLE_TEXT}Authorizing network...${RESET_FORMAT}"
...
# Task 5: Clean Up
echo -e "${RED_TEXT}${BOLD_TEXT}Deleting private cluster...${RESET_FORMAT}"
gcloud container clusters delete private-cluster --zone="$ZONE" --quiet

# Task 6: Create second private cluster
echo -e "${GOLD_TEXT}${BOLD_TEXT}Creating custom subnet...${RESET_FORMAT}"
...
echo -e "${GREEN_TEXT}${BOLD_TEXT}Creating private-cluster2...${RESET_FORMAT}"
...
echo -e "${PURPLE_TEXT}Authorizing access...${RESET_FORMAT}"
